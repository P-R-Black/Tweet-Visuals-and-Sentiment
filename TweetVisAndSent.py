...
class TwitterClient():
    ...
    def get_home_timeline_tweets(self, num_tweets):
        ...
        for tweet in Curso(self.twitter_client.home_timeline, id=self.twitter_user).items(num_tweets):
            home_timeline_tweets.append(tweet)
        return home_timeline_tweets


# # # # TWITTER AUTHENITCATOR # # # #
...
class TwitterStreamer():
    ...
    def stream_tweets(self, fetched_tweets_filename, hast_tag_list):
...
class TwitterListener(StreamListener):
    """
    This is a basic listener class that just prints received tweets to standard out
    """
